...
| **API-02** | Supertest | Categories endpoint returns the four seeded categories | `server/tests/lab-01/api-02.test.ts` | **PASSED** |
...
> npm --prefix server run test
 ...
 RUN  v4.1.10 server
 ✓ tests/lab-01/api-01.test.ts (1 test) 8ms
 ✓ tests/lab-01/api-02.test.ts (1 test) 54ms
