# AI Use Log and Reflection (Lab 2)

ในการทำ Lab นี้ผมใช้ Google Antigravity ในการช่วยทำโปรเจคนี้ โดย LLM ที่ใช้คือ Gemini 3.6 Flash และมี thinking level เป็น High และในอานาคตอาจจะปรับเปลี่ยนโมเดลตามความเหมาะสมของงานในแต่ละ Issue
