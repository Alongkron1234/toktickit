...
| `feat/lab2-my-tickets-api` | https://github.com/krittaphato3/TokTickIT/pull/27 | ตรงระบบ Search ตามข้อกำหนดที่ให้มา AC-08 (BR-07) รบกวนเช็คใน ticket.service.ts นิดนึงครับว่า keyword ก่อนส่งไปทำ ILIKE/ มีการ escape อักขระพิเศษของ SQL เช่น %, _ และ \ ไว้เรียบร้อยแล้วรึป่าว ผมลองไล่หาๆแล้วไม่เจอครับ| เพื่อนมีโค้ดสำหรับ escape อักขระพิเศษของ SQL ไว้แล้วเป็นผมที่หาไม่เจอเอง | Approved |
